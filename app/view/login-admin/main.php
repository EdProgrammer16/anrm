  ...
  <div class="container mb-5">
    <div class="row mt-5">
      <div class="col-lg-6 mt-5 mt-lg-0 mx-auto">
        <form action="<?= DIRPAGE ?>login/auth/admin" method="post" role="form" class="php-form">
              <div class="row">
              ...
              <div class="text-center mt-5"><a href="<?= DIRPAGE; ?>login/admin" class="btn btn-sm btn-outline-secondary text-white rounded-5">Logar Como Inscrito</a></div>
        </form>
      </div>
    </div>
  </div>
