<!-- ======= Hero Section ======= -->
<section id="hero2" class="d-flex flex-column justify-content-center" style="background-image: url(<?= DIRIMG; ?>/projetos/3.jpg);background-position-y: 100%;">
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-xl-8">
        <h1>Nossa Linha de Contacto</h1>
      </div>
    </div>
  </div>
 </section><!-- End Hero -->
  ...
  <section id="contact" class="contact">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Entre em contacto conosco</h2>
        </div>
      </div>
